...
matrix0 = np.loadtxt(open("C:/Users/chenl/PycharmProjects/research/traning/per_rating_matrix.csv","rb"),delimiter=",",skiprows=0)
...
autoencoder = AdditiveGaussianAutoencoder(n_input=3883, n_hidden=20, transfer_function=tf.nn.sigmoid, optimizer=tf.train.AdamOptimizer(learning_rate=0.001), scale=0.01)
...
# np.savetxt('per_auto.csv', cost_matrix, delimiter=',')